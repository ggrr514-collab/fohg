...
const CONFIG = {
  ...
  STUDENT: {
    ...
    T2_CELL:         'A13',   // 論題2 どちらの語り手が危ういか
    T3_CELL:         'A16',   // 論題3 「私」を支えるものを示せているか
...
'',
'【3つの論題】3つとも、二つの作品にまたがる問いである。',
'　論題1 仮面とデータは、同じものか（二つの作品で「私」を消しているもの）',
'　論題2 気づいている「僕」と、気づいていない「私」。どちらが危ういか（二つの語り手）',
'　論題3 二つの作品は、「私」を支えるものを示せているか（二つの結末）',
'',
'【生徒が各論題に書くこと】',
