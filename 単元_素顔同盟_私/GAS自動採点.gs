...
'　　　　　　何の問題もない」と受け入れてしまう。',
'',
'【単元の目標】自分で選んだ（または自分で立てた）観点から二つの作品を批判的に読み、',
'　それぞれの文章に表れているものの見方や考え方について考える。',
'',
'【重要】読みの観点は生徒が自分で決めている。校内の9観点（登場人物／設定／構成／視点・語り／',
'　表現の工夫／題名／主題／批評・評価／自分に生かす）から選んでもよいし、9つに無い観点を',
'　自分の言葉で立ててもよい（例「笑顔」「名前」「仕事」「制度・ルール」「気づいていない人」）。',
'　★観点そのものの当否は評価しないこと。「別の観点にすべき」という指摘もしないこと。',
'　　評価するのは、その観点から本文の根拠を示して吟味できているかである。',
'　　珍しい観点・9観点に無い観点であることを理由に評価を下げてはならない。',
'',
'【場面設定】この批評文の読み手は、まだ「素顔同盟」も「私」も読んでいない隣のクラスの友達である。',
'　読んでいない相手に伝わるよう、本文からの引用が必要である。',
'',
'【課題】自分が選んだ観点から読むと、二つの作品は「私が私であること」を何が支え、何が奪うと',
'　考えているか。二つの作品のものの見方・考え方を検討したうえで、自分の考えを書く。（800字）',
'',
'【必須条件】',
'　条件① 自分が選んだ（立てた）観点を示し、その観点から両作品をそれぞれ一か所以上引用して、',
'　　　　 その作品が「私が私であること」について何を支え・何が奪うと考えているかを示している',
'　条件② 少なくとも一方の作品の見方に対して、「しかし」「とはいえ」で始まる疑いの一文がある',
'　条件③ 話し合いで自分の考えが動いた発言に触れ、「自分の観点では見えなかったこと」を書き、',
'　　　　 自分の生活や今の社会と結んでいる',
'',
'【ルーブリック】（思考・判断・表現／5段階）',
'S：条件①②を満たし、さらに協議で自分の考えが動いた地点を示して自分の生活・社会と結んでいる。',
'　　加えて、「自分の観点だから見えたこと」と「自分の観点では見えなかったこと」の両方に触れ、',
'　　自分の読みの前提や限界を自分で述べている。',
'　　（例「私は『笑顔』という観点で読んだので、仮面を外す場面ばかり見ていた。班の人の『制度』という',
'　　　観点を聞いて、僕が向かう森も一つの制度かもしれないと気づいた」）',
'A：条件①②の両方を満たしている。自分の観点を示し、その観点から両作品を引用して',
'　　それぞれの見方のちがいを捉え、少なくとも一方の見方に「しかし／とはいえ」で疑いを差しはさんでいる。',
'B：条件①②のどちらか一方のみ。観点を示して引用しているが疑いがない、',
'　　または疑いはあるが観点が示されていない／引用が一方の作品にしかない。',
'C：両作品に触れているが、観点も引用も疑いもなく、あらすじや感想が中心。',
'D：一方の作品にしか触れていない、または未完。',
'',
'評価のポイント：',
'1. 条件①（自分の観点が示され、その観点から両作品を引用し、それが根拠になっているか）',
'2. 条件②（一方の作品の見方に「しかし／とはいえ」で疑いを差しはさんでいるか）',
'3. 条件③（協議で考えが動いた発言と「自分の観点では見えなかったこと」に触れ、',
'　 自分の生活・社会と結んでいるか）に達しているか',
'4. まだ読んでいない友達に、二つの作品の中身が伝わる書き方になっているか',
'',
'※ 1と2の両方に触れていなければ、A以上にはなりません。',
'※ 観点の種類そのものを評価の材料にしないこと。どんな観点でも、根拠を示して吟味できていれば',
'　 高く評価する。逆に、観点の名前を書いただけで本文と結びついていなければ条件①は未達とする。',
